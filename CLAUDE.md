...
- A Claude Code skill (`/jules-test`) for testing and debugging workflows via `gh` CLI
...
skill/jules-prompt/     — /jules-prompt skill + reference workflow examples and prompt blocks
skill/jules-prompt/references/shared/   — Shared prompt blocks (writing standards, instruction footers)
skill/jules-prompt/references/prompts/  — Reference system prompts (markdown)
skill/jules-prompt/references/examples/ — Ready-to-use workflow examples
skill/jules-test/       — /jules-test skill for testing workflows via gh CLI
...
- Shared prompt blocks loaded from `skill/jules-prompt/references/shared/` when config uses `instructions: "shared"`
